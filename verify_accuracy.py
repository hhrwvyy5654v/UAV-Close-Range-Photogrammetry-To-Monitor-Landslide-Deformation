...
# 四个特征点在图像上的对应点坐标
object_2d_point = np.array(([331.5 , 977.5],
                            [326.75 , 456.75],
                            [849.5 , 974.0],
                            [847.75 , 455.75]), dtype=np.double)
# 内参矩阵
camera_matrix = np.array(([437.38409032, 0, 290.88367591],
                         [0, 440.71780857, 221.67739333],
                         [0, 0, 1.0]), dtype=np.double)
# 畸变系数
dist_coefs = np.array([1.92527388e-02,1.29366216e-01,-1.55830589e-04,1.48515169e-03,-2.30971920e-01], dtype=np.double)
